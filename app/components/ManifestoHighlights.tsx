        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {manifestoPillars.map((pillar, i) => {
            ...
            return (
              <motion.div
                key={pillar.title}
                className="bg-white rounded-2xl p-6 shadow-md border-l-4 border-[#d4a017] hover:-translate-y-1 transition-all duration-300 cursor-default"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
              >
                <div className="w-12 h-12 rounded-xl bg-[#0d2b14] flex items-center justify-center mb-4">
                  <Icon className="w-6 h-6 text-[#d4a017]" />
                </div>
                <h3 className="font-playfair font-bold text-[#0d2b14] text-xl mb-2">
                  {pillar.title}
                </h3>
          ...
          <motion.div
            className="rounded-2xl p-6 flex flex-col items-center justify-center text-center gap-4 border-2 border-dashed border-[#d4a017]/40 hover:-translate-y-1 transition-all duration-300"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.5 }}
          >
            <p className="font-playfair font-bold text-[#0d2b14] text-lg">
