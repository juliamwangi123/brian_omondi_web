  ...
  return (
    <section className="w-full mt-0">
      <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x-2 divide-white/40">
        ...
        <motion.div
          className="bg-[#000073] flex flex-col items-center justify-center text-center px-12 py-5 gap-6 mr-0 md:mr-1 mb-1 md:mb-0"
        ...
        <motion.div
          className="bg-[#000073] flex flex-col items-center justify-center text-center px-12 py-5 gap-6 mr-0 md:ml-1"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
