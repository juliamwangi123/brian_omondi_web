  ...
  return (
    <section className="w-full mt-0">
      <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x-2 divide-white/40">
        ...
        <motion.div
          className="bg-[#000073] flex flex-col items-center text-center px-12 pt-6 pb-6 gap-6 mr-0 md:mr-1 mb-1 md:mb-0"
        ...
        >
          ...
          <Link
            href="/about"
            className="mt-auto text-white hover:text-white/70 transition-colors duration-200"
        ...
        <motion.div
          className="bg-[#000073] flex flex-col items-center text-center px-12 pt-6 pb-6 gap-6 mr-0 md:ml-1"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-white/80 leading-relaxed max-w-sm" style={{ fontFamily: 'Century_Gothic_Regular', fontSize: '24px' }}>
              Eight pillars. Four wards.<br />One vision for Mumias West.
            </p>
          </div>
          <Link
            href="/manifesto"
